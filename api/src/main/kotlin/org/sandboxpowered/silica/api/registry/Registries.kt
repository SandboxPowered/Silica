...
import org.sandboxpowered.silica.api.gameevent.GameEvent
...
object Registries {
    ...
    val FLUIDS: Registry<Fluid> = SilicaAPI.getRegistry()
    ...
    val GAME_EVENTS: Registry<GameEvent> = SilicaAPI.getRegistry()
}